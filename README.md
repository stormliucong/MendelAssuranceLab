...
- Populate `policy-document/`, add file name and make it clearly.
    ...
    - Modify `prompt.md` to replace `policy-documents/policy_789` with extra folder name (e.g. `policy-documents/policy_789`) where you want agent to search relevant files.
